...
const TableItem = ({ table, setActiveTable, setTables, number }) => {
    ...
    const handleSwitchChange = useCallback(
        debounce(async () => {
            ...
            try {
                await toast.promise(
                    apiRequest("/api/questionary/tables", formData, "PUT"),
                    {
    ...
    return (
        <>
            ...
            >
                ...
                <TableCell>{table?.hint}</TableCell>
                ...
                <TableCell>
                    <Button
                        onClick={() =>
                            router.push(`/questionary/tables/${table?.id}`)
                        }
                    >
                        Наповнення
                    </Button>
