...
import { questionaryRoomTableSchema } from "@/components/adminpanel/Questionnaire/RoomTables/table/validation";
import { useRouter } from "next/navigation";

const RoomTableForm = ({ activeTable, onClose, setTables }) => {
    ...
    const methods = useForm({
        ...
        resolver: zodResolver(questionaryRoomTableSchema),
    });
        ...
        try {
            await toast.promise(
                ...
                ),
                {
                    ...
                    success: (newTable) => {
                        if (isUpdate) {
                            router.replace("/questionary/roomTables");
                            methods.reset();
                            onClose();
    ...
    const deleteHandler = async () => {
        try {
            await toast.promise(
                apiRequest(
                    `/api/questionary/tables/room?id=${activeTable?.id}`,
                    undefined,
                    "DELETE"
                ),
                {
